...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col justify-center items-center px-6 relative pt-18 md:pt-20"
    >
      ...
      <div className="w-full max-w-5xl mx-auto mt-12 md:mt-8 overflow-hidden border border-[#eaddcf] rounded-2xl bg-[#eaddcf]/30 py-4">
